...
namespace Kalendář_EOW_Release
{
    partial class vyberDatumuG
    {
        ...
        private void InitializeComponent()
        {
            ...
            0,
            0});
            this.ciselnikDen.ValueChanged += new System.EventHandler(this.ciselnik_ValueChanged);
            this.ciselnikDen.Validating += new System.ComponentModel.CancelEventHandler(this.vyberDatumuG_Validating);
            this.ciselnikDen.Validated += new System.EventHandler(this.vyberDatumuG_Validated);
            // 
            // ciselnikRok
            // 
            ...
            0,
            0});
            this.ciselnikRok.ValueChanged += new System.EventHandler(this.ciselnik_ValueChanged);
            this.ciselnikRok.Validating += new System.ComponentModel.CancelEventHandler(this.vyberDatumuG_Validating);
            this.ciselnikRok.Validated += new System.EventHandler(this.vyberDatumuG_Validated);
            // 
            // ciselnikMesic
            // 
            ...
            0,
            0});
            this.ciselnikMesic.ValueChanged += new System.EventHandler(this.ciselnik_ValueChanged);
            this.ciselnikMesic.Validating += new System.ComponentModel.CancelEventHandler(this.vyberDatumuG_Validating);
            this.ciselnikMesic.Validated += new System.EventHandler(this.vyberDatumuG_Validated);
            // 
            // popisekDen
            // 
            ...
            this.Name = "vyberDatumuG";
            this.ShowInTaskbar = false;
            this.Text = "Datum Greoriánského kalendáře";
            this.Resize += new System.EventHandler(this.vyberDatumuG_Resize);
            this.Validating += new System.ComponentModel.CancelEventHandler(this.vyberDatumuG_Validating);
            this.Validated += new System.EventHandler(this.vyberDatumuG_Validated);
